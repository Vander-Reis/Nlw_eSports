...
<h3 align="center">
	Site mostrando meus jogos preferidos, e canais que eu acompanho.
</h3>
...
```bash
$ git clone https://github.com/Vander-Reis/Nlw_eSports
```

## Usage
To use this project, follow the steps above:
```bash
Para rodar o meu projeta basta abrir em localhost.
```
